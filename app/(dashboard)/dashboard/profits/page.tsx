  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight">{t("dashboard.profits.title")}</h1>
          <p className="text-muted-foreground text-sm">{t("dashboard.profits.subtitle")}</p>
        </div>
      </div>
      <Card>
        <CardHeader className="space-y-4">
          <div className="flex flex-col justify-between gap-3 lg:flex-row lg:items-center">
            <div>
              <CardTitle>{t("dashboard.profits.summaryTitle")}</CardTitle>
            </div>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
              <div className="rounded-lg border p-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">{t("dashboard.common.revenue")}</p>
                ...
                <p className="text-muted-foreground mt-1 text-xs">
                  {t("dashboard.profits.metrics.revenueHint")}
                </p>
              </div>
              <div className="rounded-lg border p-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">{t("dashboard.profits.metrics.salesCost")}</p>
                ...
                <p className="text-muted-foreground mt-1 text-xs">
                  {t("dashboard.profits.metrics.salesCostHint")}
                </p>
              </div>
              <div className="rounded-lg border bg-green-50 p-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">{t("dashboard.profits.metrics.grossProfit")}</p>
                ...
                <p className="text-muted-foreground mt-1 text-xs">
                  {t("dashboard.profits.metrics.grossProfitHint")}
                </p>
              </div>
              <div className="rounded-lg border bg-red-50 p-4 text-red-600">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">{t("dashboard.nav.expenses")}</p>
                ...
                <p className="text-muted-foreground mt-1 text-xs">
                  {t("dashboard.profits.metrics.expensesHint")}
                </p>
              </div>
              <div className="rounded-lg border bg-green-100 p-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium">{t("dashboard.profits.metrics.netProfit")}</p>
                ...
                <p className="text-muted-foreground mt-1 text-xs">
                  {t("dashboard.profits.metrics.netProfitHint")}
                </p>
              </div>
            </div>
          )}
