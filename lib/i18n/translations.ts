...
export const translations = {
  sw: {
    ...
    about: {
      ...
      subtitle: "POS, mauzo, inventory na ankara kwa biashara zinazokua.",
      missionTitle: "Lengo letu",
      missionContent:
        "Kuwapa wafanyabiashara mfumo rahisi wa kurekodi mauzo, kusimamia bidhaa na huduma, kutengeneza ankara na quotations, na kuelewa faida ya biashara bila mfumo mzito wa accounting.",
      visionTitle: "Maono",
      visionContent:
      ...
      value3Description:
        "Imejengwa kwa mahitaji ya biashara za Kiafrika: mauzo ya kila siku, inventory, wateja na ripoti rahisi.",
      teamTitle: "Timu yetu",
      teamDescription:
    ...
    terms: {
      ...
      section2Content:
        APP_NAME +
        " inatoa jukwaa la POS na usimamizi wa biashara: kurekodi mauzo, kusimamia inventory, wateja, quotations na ankara. Tunahifadhi data yako kwa usalama na kufuata sera yetu ya faragha.",
    ...
    privacy: {
      ...
      section1Content:
        "Tunakusanya jina, barua pepe, nambari ya simu (hiari), maelezo ya biashara, wateja, bidhaa/huduma, mauzo, ankara na quotations unazoongeza kwenye mfumo.",
      section2Title: "Jinsi tunavyotumia taarifa",
      section2Content:
        "Tunatumia taarifa zako kuendesha akaunti yako, kuonyesha sales, inventory, wateja, ankara na ripoti, na kuboresha jukwaa. Tunaweza kutumia barua pepe au simu kwa arifa muhimu kuhusu akaunti na huduma zetu.",
    ...
    landing: {
      ...
      heroLabel: "POS na usimamizi wa biashara kwa Afrika",
      ...
      pricing: {
        ...
        pro: {
          name: "Pro",
          description: "Kwa biashara zinazokua zinazohitaji mauzo, inventory na ripoti zaidi.",
          price: "24,000",
          period: "/mwezi",
          cta: "Chagua mpango huu",
          features: [
            "Mauzo na ankara zaidi kwa mwezi",
            "Inventory na stock history",
            "Ripoti za mauzo na faida",
        ...
        business: {
          ...
          cta: "Wasiliana nasi",
          features: [
            "Mauzo na ankara zisizo na kikomo",
            "Biashara au matawi mengi",
            "API na uunganishaji",
            "Meneja akaunti",
          ],
        },
  ...
  en: {
    ...
    privacy: {
      ...
      section1Content:
        "We collect the name, email, phone number (optional), business details, clients, products/services, sales, invoices and quotations you add to the platform.",
    ...
    landing: {
      ...
      heroLabel: "POS and business management for Africa",
      ...
      testimonials: {
        ...
        two: {
          quoteStart: "Inventory and sales are ",
          quoteHighlight: "in one place",
          quoteEnd: ", so we know which products move fastest.",
          name: "Jonathan S.",
      ...
      pricing: {
        ...
        free: {
          ...
          features: [
            ...
            "Clients and walk-in customer",
            "Basic invoices and quotations",
          ],
        },
        pro: {
          name: "Pro",
          description:
            "For growing businesses that need more sales, inventory and reporting capacity.",
          price: "$9",
          period: "/month",
          cta: "Choose this plan",
          features: [
            "More monthly sales and invoices",
